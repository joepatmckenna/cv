...
- Relevant coursework: Topology, $\textstyle{\LaTeX}$
* Publications
...
- Developed mathematical model of the insulin secretory pathway in pancreatic \beta-cells. Proposed a novel hypothesis of energy use in \beta-cells that has potential applications to the treatment and prevention of type 2 diabetes.
