...
#+html_head: <link rel="stylesheet" type="text/css" href="joepatmckenna.github.io/css/cv.css">
#+subtitle: Joseph P. McKenna
#+infojs_opt: view:showall sdepth:2 ltoc:nil mouse:#cfcfcf
...
email: jmckenna@fsu.edu
web: [[http://joepatmckenna.github.io]]
...
- Relevant coursework: Topology, $\LaTeX$
* Publications
- J. P. McKenna, R. Dhumpa, N Mukhitov, M. G. Roper, and R. Bertram, /Glucose oscillations can activate an endogenous oscillator in pancreatic islets/, submitted May 2016, PLOS Computational Biology.
...
- 9/09 - 5/08: /Linear algebra/, /Calculus I & II/ small-group tutor
...
- Created Java program that assembled language-learning lessons from interviews with speakers of languages native to Ghana, West Africa.
...
* Technical Abilities
- Programming: C, C++, Fortran, Python, MATLAB, UNIX, Java, HTML, Javascript, CSS, $\LaTeX$, XPP, AUTO
...
- 4/16: Graduate student poster contest 3^{rd} place, Florida State University
