...
\usepackage{capt-of}
\usepackage{hyperref}
\author{Joseph P. McKenna\thanks{joepatmckenna@gmail.com}}
\date{\today}
...
\label{sec:org09d473c}
\begin{itemize}
\item Relevant coursework: Topology, Logic, \(\textstyle{\LaTeX}\)\\
\end{itemize}
\section*{Publications}
\label{sec:org43bb2a2}
\begin{itemize}
\item E. Kim, R. Schenck, J. West, W. Cross, V. Harris, J. McKenna, H. Cho, E. Coker, S. Lee-Kramer, K. Tsai, E. Flores, C. D. Gatenbee, \emph{Targeting the untargetable: predicting Pramlintide resistance using a neural network based cellular automata}, bioRxiv, 2017, \href{http://dx.doi.org/10.1101/211383}{10.1101/211383}\\
...
\label{sec:org62fe182}
\subsection*{10/17 - present: Postdoctoral fellow, National Institutes of Health, Laboratory of Biological Modeling}
\label{sec:org69a0ae8}
\subsection*{7/16 - 5/17: Research assistant, Florida State University}
\label{sec:orge09580e}
\begin{itemize}
\item Formed and analyzed a model of pancreatic \(\beta\)-cells to better understand their role in diabetes. Specifically, investigated the importance of Ca\(^{\text{2+}}\)-activation of mitochondria for maintaining normal oscillatory insulin release from \(\beta\)-cells. Funding from NSF grant DMS 1612193.\\
\end{itemize}
\subsection*{5/14 - 8/14: Intern, National Institutes of Health, Laboratory of Biological Modeling}
\label{sec:org66bb9e1}
\section*{Conferences and Workshops}
\label{sec:orgc6feaab}
\begin{itemize}
...
\end{itemize}
\section*{References}
\label{sec:org83dcfd8}
\subsection*{Dr. Richard Bertram}
\label{sec:org8f62c0c}
